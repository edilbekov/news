      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        ...
        <div class="fashion_technology_area">
            <div class="fashion">
              ...
              <h2><span>{{$all[0]['category']}}</span></h2>
              <?php
                  foreach($all as $item){            
              ?>                
                <ul class="business_catgnav wow fadeInDown">
                  <li>
                    <figure class="bsbig_fig"> <a href="/single_page/<?=$item['id']?>" class="featured_img"> <img alt="" src="images/<?=$item['file_name']?>"> <span class="overlay"></span> </a>
                      <figcaption> <a href="/single_page/<?=$item['id']?>"><?=$item['title']?></a> </figcaption>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="footer_widget wow fadeInRightBig">
            <h2>Contact</h2>
            <p>Sorawlariniz bolsa biymalel qisinbay bere berin yaqshima?</p>
            <address>
