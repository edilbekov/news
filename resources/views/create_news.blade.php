...
<form action="{{route('create')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <textarea rows = "5" cols = "50" name = "title" placeholder="Title" required></textarea>
    <textarea rows = "5" cols = "50" name = "description" placeholder="Description" required></textarea>
    <textarea rows = "5" cols = "50" name = "news" placeholder="Text here!" required></textarea>
    ...
    <input type="file" name="file" id="$id" accept="image/*" required>
